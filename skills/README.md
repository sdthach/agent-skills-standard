...
- [**Specialist Codebase Locator**](specialists/specialist-codebase-locator/SKILL.md) (P1) - Locates files, directories, and components relevant to a task — a fast file-location super-tool. Use to find WHERE code lives before analyzing it.
