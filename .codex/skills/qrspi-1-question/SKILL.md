...
description: "qrspi phase 1/8: decompose a ticket, issue, or task into neutral, answerable research questions. Start of the qrspi flow; writes questions.md to the artifact dir. Next: qrspi-2-research."
metadata:
  triggers:
    keywords:
    - qrspi 1 question
    - workflow
---
# Qrspi 1 Question Skill

> [!IMPORTANT]
> qrspi phase 1/8: decompose a ticket, issue, or task into neutral, answerable research questions. Start of the qrspi flow; writes questions.md to the artifact dir. Next: qrspi-2-research.
...
- Tell the user: "Next: run the **qrspi-2-research** workflow."
