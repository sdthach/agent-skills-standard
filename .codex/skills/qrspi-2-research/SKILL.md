...
description: "qrspi phase 2/8: objective, questions-driven codebase research — facts only, no opinions. Reads questions.md; writes research.md. Run after qrspi-1-question. Next: qrspi-3-design."
metadata:
  triggers:
    keywords:
    - qrspi 2 research
    - workflow
---
# Qrspi 2 Research Skill

> [!IMPORTANT]
> qrspi phase 2/8: objective, questions-driven codebase research — facts only, no opinions. Reads questions.md; writes research.md. Run after qrspi-1-question. Next: qrspi-3-design.
...
Read the `questions.md` file in the artifact directory. That file is your only input.
...
- Tell the user: "Next: run the **qrspi-3-design** workflow."
...
If the questions are poorly framed — too vague, targeting the wrong areas, or missing an obvious part of the codebase — tell the user and suggest re-running the **qrspi-1-question** workflow with adjusted input rather than producing weak research.
