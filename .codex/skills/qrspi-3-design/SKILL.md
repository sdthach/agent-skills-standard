---
name: qrspi-3-design
description: "qrspi phase 3/8: design discussion to align on direction before planning how. Reads research.md; writes design.md. Run after qrspi-2-research. Next: qrspi-4-structure."
metadata:
  triggers:
    keywords:
    - qrspi 3 design
    - workflow
---
# Qrspi 3 Design Skill

> [!IMPORTANT]
> qrspi phase 3/8: design discussion to align on direction before planning how. Reads research.md; writes design.md. Run after qrspi-2-research. Next: qrspi-4-structure.
...
Read the `task.md`, `questions.md`, and `research.md` files in the artifact directory.
...
- Tell the user: "Next: run the **qrspi-4-structure** workflow."
...
If the research is missing critical information needed for design decisions — the questions missed an important area of the codebase — tell the user and suggest re-running the **qrspi-1-question** and **qrspi-2-research** workflows to fill the gap before proceeding with an incomplete design.
