...
description: "qrspi phase 4/8: structure outline — vertical slices with test checkpoints. Reads design.md; writes structure.md. Run after qrspi-3-design. Next: qrspi-5-plan."
metadata:
  triggers:
    keywords:
    - qrspi 4 structure
    - workflow
---
# Qrspi 4 Structure Skill

> [!IMPORTANT]
> qrspi phase 4/8: structure outline — vertical slices with test checkpoints. Reads design.md; writes structure.md. Run after qrspi-3-design. Next: qrspi-5-plan.
...
Read the `design.md` and `research.md` files in the artifact directory.
...
- Tell the user: "Next: run the **qrspi-5-plan** workflow."
...
If you discover the design missed a critical constraint or made a decision based on incorrect assumptions about the codebase, tell the user and suggest re-running the **qrspi-3-design** workflow rather than working around a flawed design.
