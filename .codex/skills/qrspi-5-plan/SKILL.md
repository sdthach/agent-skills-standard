---
name: qrspi-5-plan
description: "qrspi phase 5/8: tactical implementation plan, the working document. Reads structure.md; writes plan.md. Run after qrspi-4-structure. Next: qrspi-6-worktree or qrspi-7-implement."
metadata:
  triggers:
    keywords:
    - qrspi 5 plan
...
> [!IMPORTANT]
> qrspi phase 5/8: tactical implementation plan, the working document. Reads structure.md; writes plan.md. Run after qrspi-4-structure. Next: qrspi-6-worktree or qrspi-7-implement.
...
Read the `structure.md`, `design.md`, and `research.md` files in the artifact directory.
...
- Tell the user: "Next: run the **qrspi-6-worktree** workflow to set up an isolated worktree, or the **qrspi-7-implement** workflow to implement in the current tree."
...
If expanding the structure reveals that a phase can't be implemented as outlined — missing information, incorrect assumptions, or a structural issue — tell the user and suggest re-running the **qrspi-4-structure** workflow or the **qrspi-3-design** workflow rather than writing a plan you know is flawed.
